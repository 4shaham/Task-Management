...
export default class TaskUseCase implements ITaskUseCase{
    ...
    async getAllTask(startDate:Date,endDate:Date,managerId:string):Promise<ITask|null[]>{
         try {
            

           return await this.taskRepository.getAllTask(startDate,endDate,managerId)
